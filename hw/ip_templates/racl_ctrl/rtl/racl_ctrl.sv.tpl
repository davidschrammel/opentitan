...
% endfor
  ...
  always_comb begin
    ...
    racl_error_access_type = racl_ctrl_racl_error_log.access_type;
    for (int i = 0; i < NumSubscribingIps; i++) begin
      ...
      racl_error_access_type |= racl_error_log_i[i].access_type;
    end
  end
  ...
  assign hw2reg.error_log.access_type.d  = clear_log ? '0 : racl_error_access_type;
  assign hw2reg.error_log.access_type.de = first_error | clear_log;
